...
(function () {
      ...
      '<div class="modal" id="register-modal" role="dialog" aria-modal="true" aria-labelledby="register-modal-title">' +
        ...
        '<div class="modal__dialog">' +
          ...
          '<div class="store-badges">' +
            // TODO: ganti href '#' dengan tautan app store resmi dari klien
            '<a class="store-badge" href="#" aria-label="Download on the App Store">' + icon('i-download') + '<span><small>Download di</small><b>App Store</b></span></a>' +
            '<a class="store-badge" href="#" aria-label="Get it on Google Play">' + icon('i-download') + '<span><small>Download di</small><b>Google Play</b></span></a>' +
          '</div>' +
  ...
  function activeTicketWeek() {
    // Determine current ticket phase by August week, else general once past.
    var ref = new Date();
    var aug = { 1: new Date('2026-08-01T00:00:00+07:00'), 2: new Date('2026-08-08T00:00:00+07:00'), 3: new Date('2026-08-15T00:00:00+07:00') };
    if (ref < aug[1]) return 0;          // not yet on sale
    if (ref < aug[2]) return 1;
    if (ref < aug[3]) return 2;
